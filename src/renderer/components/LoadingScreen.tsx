...
export const LoadingScreen: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-neutral-900 relative">
      ...
      {/* Loading spinner */}
      <div className="w-8 h-8 border-3 border-brand-200 dark:border-brand-800 border-t-brand-500 rounded-full animate-spin" />

      <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">Loading your fitness data...</p>
    </div>
  );
};
