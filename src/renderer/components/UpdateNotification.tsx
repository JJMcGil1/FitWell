...
import { HiOutlineXMark, HiOutlineArrowDownTray, HiOutlineCheck, HiOutlineClipboardDocument } from 'react-icons/hi2';
          ...
          <div className="pr-6">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-8 h-8 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center">
                <HiOutlineArrowDownTray className="w-4 h-4 text-green-600 dark:text-green-400" />
              </div>
              <div>
